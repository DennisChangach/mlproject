...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            #Split the dependent and indendepent variables/features
            ...
            #Creating dictionary of models to experiment
            models = {
            ...
            #Retrieving the best model from the models dict
            ...
            logging.info(f"Model predictions have a score of:{r2_square}")
